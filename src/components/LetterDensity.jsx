...
function LetterDensity() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <p className="text-2xl font-semibold tracking-tighter text-neutral-800 dark:text-neutral-800">
        Letter Density
      </p>

      {isTextEmpty && (
        <p className="text-base font-normal tracking-tighter text-neutral-800 dark:text-neutral-800">
        ...
        <>
          <div className="flex flex-col gap-3">
            {(showAll ? density : density.slice(0, 5)).map((item) => (
              ...
              >
                <p className="min-w-4 text-base font-normal tracking-tighter text-neutral-800 dark:text-neutral-800">
                  {item.letter}
                </p>
                ...
                <p className="flex min-w-[5.625rem] items-center justify-end gap-1 text-base font-normal tracking-tighter text-neutral-800 dark:text-neutral-800">
          ...
          {density.length > 5 && (
            <button
              onClick={toggleText}
              className="flex cursor-pointer items-center gap-2 self-start text-xl font-normal tracking-tighter text-neutral-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-500 dark:text-neutral-800"
            >
              ...
              >
                <path
                  ...
                  className="fill-neutral-800 dark:fill-neutral-800"
                />
              </svg>
            </button>
          )}
